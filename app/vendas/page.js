                  ...
                  {(porFase[fase] || []).map((lead) => {
                    ...
                    return (
                      <div
                        ...
                        role="button"
                        tabIndex={0}
                        onKeyDown={(e) => { if (e.key === 'Enter') setLeadAberto(lead); }}
                        className="bg-white rounded-md p-3 text-left shadow-sm hover:shadow-md transition-shadow border border-slate-200 cursor-pointer"
                      >
